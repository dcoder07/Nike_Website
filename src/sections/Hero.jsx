  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 pl-16 leading-10 '>
        <p className='text-[#FF6452] font-monteserrat relative mt-10  bottom-10 text-lg'>Our Summer collections</p>
        <h1 className='xl:whitespace-nowrap text-8xl relative z-10 font-bold spacing-x-2'>The New Arrival<br/>
        ...
        <div className='flex justify-start gap-8 p-2 m-5 items-start flex-wrap w-full mt-20'>
